    ...
    const listItems = items.map(item =>
        {return(
            ...
            <div className="container4 pl-5" id={item.key}>
                ...
                <div className='todo-btn d-flex'><button className='btn btn-outline-danger align-self-center ml-5 align-items-end ' onClick={()=> this.props.deleteItem(item.key)}>Delete</button></div>
